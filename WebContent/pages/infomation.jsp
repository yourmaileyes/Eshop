...
line-height: 48px;
color: #787d82;background-color: #e7e7e7;
...
<li><span onclick="showorder()" style="font-size: 25px;cursor: pointer;
...
<input class="denglu-input" id="username1" name="username" type="text" value="${loginUser.username }"><br><br><br>
<label for="phone">手机号</label>
<input class="denglu-input" id="phone" name="phone" type="text" value="${loginUser.phone }"><br><br><br>
<label for="addr">地&nbsp;&nbsp;&nbsp;&nbsp;址</label>
<input class="denglu-input" id="addr" name="addr" type="text" value="${loginUser.addr }"><br><br><br>
<span id="tishitishi" style="color: red;font-size: 20px;"></span>
</form>
 </div>
 <button onclick="info();" style="color: #333;
background-color: #e6e6e6;
border-color: #adadad;padding: 6px 12px;margin-bottom: 0;font-size: 14px;
font-weight: 400;line-height: 1.42857143;text-align: center;
white-space: nowrap;
cursor: pointer;border: 1px solid transparent;margin-left:700px;width:100px;height:50px;
border-radius: 4px;">提交</button>
</div>
</div>
...
function info(){
	...
	var isok = true;
	if(username==""||phone==""){
		$("#tishitishi").text("用户名或手机号不能为空");
		isok = false;
		return ;
	}
	if(addr==""){
		$("#tishitishi").text("地址不能为空");
		isok = false;
		return ;
	}
	$
